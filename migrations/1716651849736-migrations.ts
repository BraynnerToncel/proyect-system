...
export class Migrations1716651849736 implements MigrationInterface {
...
`);
    await queryRunner.query(`
INSERT INTO public.user ("userId","userFullName","userLastName","username","userEmail","userPassword","userState","roleRoleId")
VALUES ('9db7a487-c944-47a2-a5f6-77a4287edcdf','admin','admin','admin','admin@admin.com','$2a$10$BbW6jeQa5DRe5u.uN8KMIeY2C82quaNRgD6on6YETvU0oz0mctNBO',true,'4bb8811c-e550-4032-8e1d-4d0296ab60b6');
`);
  }
